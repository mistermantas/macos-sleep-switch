...
- The v2.3.2 Mac candidate is build 19. It adds reliable ChatGPT/Codex and OpenCode detection, charging-rate telemetry, the review fixes, local Insights,
...
Creator → Version 2.3.2 (19)**, open **Insights…**, demonstrate the history

...
The repository contains the SwiftUI target `SleepSwitchCompanion`. It is an MB Uncascade app with display name Sleep Switch, version `2.3.6 (27)`, targets iOS/iPadOS 17, and uses bundle identifier `lt.mantas.sleepswitch.companion`.
